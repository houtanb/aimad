...
IMPLICIT NONE
SAVE
INTEGER :: neq, nlag, nlead, nobservedvars, nbdirs, nbdirs0
...
DOUBLE PRECISION, POINTER, DIMENSION(:,:) :: h, zdata, hd
DOUBLE PRECISION, POINTER, DIMENSION(:) :: psi, psid, uprbndx, lwrbndx
!DOUBLE PRECISION :: theh = 0.0000001d0
DOUBLE PRECISION :: theh = .000001d0
